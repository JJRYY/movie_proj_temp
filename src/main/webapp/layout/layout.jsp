...
<head>
	<meta charset="UTF-8">
	<title>title</title>
	<link rel="stylesheet" href="${contextPath}/layout/css/layout.css">
	<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.0/css/all.min.css" rel="stylesheet"> <!-- fontawesome 추가 필요 -->
</head>
<body>
	<header>
		<a href="${contextPath}/main"><img id="header_ci" alt="브랜드 로고" src="${contextPath}/layout/ci_bw.png"></a>
		<div>
			<a href="#">로그인</a>
			<a href="#">회원가입</a>
			<a href="#">바로예매</a>
	...
	<footer>
		<div id="content">
			<img id="footer_ci" alt="브랜드 로고" src="${contextPath}/layout/ci_bw.png">
			<div id="textarea">
